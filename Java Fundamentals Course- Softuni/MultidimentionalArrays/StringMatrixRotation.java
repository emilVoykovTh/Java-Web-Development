...
public class StringMatrixRotation {
    ...
    public static void main(String[] args) {
        ...
        if (degrees == 90) {
            rotate90(input, length, matrix);
        } else if (degrees == 0) {
            printMatrix(input, length, matrix);
        } else if (degrees == 180) {
            rotate180(input, counter, length, matrix);
        } else if (degrees == 270) {
            rotate270(input, length, matrix);
        }
    }
    ...
    private static void rotate270(ArrayList<String> list, int length, char[][] matrix) {
        ...
        printMatrix(list, length, newMatrix);
    }

    private static void rotate180(ArrayList<String> list, int counter, int length, char[][] matrix) {
    ...
    private static void printMatrix(ArrayList<String> list, int length, char[][] matrix) {
        for (int r = 0; r < matrix.length; r++) {
    ...
    private static void rotate90(ArrayList<String> list, int length, char[][] matrix) {
        char[][] newMatrix = new char[length][list.size()];
        int i = 0;
